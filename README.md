...
This is a [Commodore][commodore] Component for OpenShift 4 Version.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/openshift4-version).
